...
export class MigracionesAdri1780280673864 implements MigrationInterface {
    name = 'MigracionesAdri1780280673864'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "clientes" ("id" SERIAL NOT NULL, "carnet" integer NOT NULL DEFAULT '0', "complemento" character varying, "nombre" character varying NOT NULL, "apellido" character varying NOT NULL, "telefono" character varying NOT NULL, "estado" boolean NOT NULL, CONSTRAINT "PK_d76bf3571d906e4e86470482c08" PRIMARY KEY ("id"))`);
